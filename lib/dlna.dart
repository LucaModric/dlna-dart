...
class XmlText {
  static String setPlayURLXml(
   ...
   // 1.先拼原始DIDL‑Lite文本
  final rawDidl = '''<DIDL-Lite xmlns="urn:schemas-upnp-org:metadata-1-0/DIDL-Lite/" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:upnp="urn:schemas-upnp-org:metadata-1-0/upnp/" xmlns:dlna="urn:schemas-dlna-org:metadata-1-0/">
<item id="id" parentID="0" restricted="0">
  <dc:title>$title</dc:title>
  <upnp:artist>unknow</upnp:artist>
  <dc:date>$time</dc:date>
  <upnp:class>$oclass</upnp:class>
  $res
</item>
</DIDL-Lite>''';

  // 2.关键修复：整块DIDL再外层转义一次！
  final encodedDidl = htmlEncode(rawDidl);
...
<s:Envelope xmlns:s="http://schemas.xmlsoap.org/soap/envelope/" s:encodingStyle="http://schemas.xmlsoap.org/soap/encoding/">
    <s:Body>
        <u:SetAVTransportURI xmlns:u="urn:schemas-upnp-org:service:AVTransport:1">
            ...
            <CurrentURIMetaData>$encodedDidl</CurrentURIMetaData>
        </u:SetAVTransportURI>
    </s:Body>
</s:Envelope>
        ''';
